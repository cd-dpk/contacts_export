package com.example.user.contacts_export.data.db;
...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    public static final String DATABASE_NAME = "CONTACTS_EXPORT";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(new Contact().toCreateTableString());
        Log.d("Table",new Contact().toCreateTableString());
    }
